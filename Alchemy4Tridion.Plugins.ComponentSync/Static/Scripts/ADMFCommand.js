...
Alchemy.command("${PluginName}", "ADMF", {
    init: function () {
    ...
    execute: function (selection)
    {
        if (purpose == "Component")
        {
            ...
            Alchemy.Plugins["${PluginName}"].Api.ComponentSyncService.getSynchronized({ tcm: selection.getItem(0), flag: "ApplyDefaultValuesForMissingMandatoryFields" })
