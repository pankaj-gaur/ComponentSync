...
Alchemy.command("${PluginName}", "Sync", {
    init: function () {
    ...
    execute: function (selection) {
        if (purpose == "Component")
        {
            ...
            Alchemy.Plugins["${PluginName}"].Api.ComponentSyncService.getSynchronized({ tcm: selection.getItem(0), flag: "ALL" })
        ...
        {
            $messages.registerProgress("Incorrect selection. Supported Type: Component Schema and Components only", null);
        }
    }
});